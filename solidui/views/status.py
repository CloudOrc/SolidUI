...
class Status:
    ...
    PASSWORD_NAME_NULL = (10003, "password is null", "密码不能为空")
    ...
    DATASOURCE_ALREADY_EXISTS_ERROR = (10059, "datasource already exists error", "数据源已经存在错误")

    CREATE_DATASOURCE_TYPE_ERROR = (10060, "create datasource type error", "创建数据源类型错误")

    QUERY_DATASOURCE_TYPE_ERROR = (10061, "query datasource type error", "查询数据源类型错误")
    ...
    UPDATE_DATASOURCE_TYPE_KEY_ERROR = (10064, "update datasource type key error", "更新数据源键值错误")
    ...
    def __init__(self, code, en_msg, zh_msg):
        self.code = code
        self.en_msg = en_msg
        self.zh_msg = zh_msg
